...
namespace SaveLoadSystemBuilding.Editor
{
    ...
    [CustomEditor(typeof(SaveablePrefabsBuilding))]
    public class SaveablePrefabsEditorBuilding : Editor
    {
        public struct ConflictData
        {
            public SaveableEntityBuilding obj1;
            public SaveableEntityBuilding obj2;
            public string ID1;
            public string ID2;
            public int index1;
            public int index2;
        ...
        static SerializedObject saveablePrefabs
        {
            get
            {
                ...
                {
                    SaveablePrefabsBuilding stor = SaveablePrefabsBuilding.instance;
        ...
        void DisplayList(List<ConflictData> conflicts)
        {
            ...
            for (int i = 0; i < list.arraySize; ++i)
            {
                ...
                SaveableEntityBuilding prefab = (SaveableEntityBuilding)elem.objectReferenceValue;
        ...
        public static void Add(SaveableEntityBuilding pref)
        {
            if (pref == null)
            {
        ...
        public static void Add(SaveableEntityBuilding pref, string ID)
        {
            if (pref == null)
            {
                Debug.LogWarning("Prefab you trying to add is null");
        ...
        public static void Remove(SaveableEntityBuilding pref)
        {
            if (pref == null)
            {
        ...
        public static int Index(SaveableEntityBuilding pref)
        {
            if (pref == null)
                return -1;
            SerializedProperty list = listProperty;
        ...
        public static int Index(string ID)
        {
            ...
            for (int i = 0; i < list.arraySize; ++i)
            {
                ...
                if (elem1 != null)
                {
                    SaveableEntityBuilding obj = (SaveableEntityBuilding)elem1.objectReferenceValue;
                    if (obj == null)
                        return -1;
        ...
        public static bool Exists(SaveableEntityBuilding pref)
        {
            if (pref == null)
                return false;
            return Index(pref) >= 0;
        }
        public static bool Exists(SaveableEntityBuilding pref, string ID)
        {
            if (pref == null || ID == "")
                return false;
            int i = Index(ID);
        ...
        public static void ReplaceID(string oldID, string newID)
        {
            ...
            if (list == null)
                return;
            SerializedProperty elem = list.GetArrayElementAtIndex(index);
            SaveableEntityBuilding obj = (SaveableEntityBuilding)elem.objectReferenceValue;
        ...
        public static void ReplacePrefab(SaveableEntityBuilding oldPref, SaveableEntityBuilding newPref)
        {
        ...
        public static string GetID(SaveableEntityBuilding pref)
        {
            if (pref == null)
                return "";
            int index = Index(pref);
        ...
        public static void GenerateListWithAllPrefabs()
        {
            ...
            {
                SaveableEntityBuilding prefab = AssetDatabase.LoadAssetAtPath<SaveableEntityBuilding>(AssetDatabase.GUIDToAssetPath(p));
                if (prefab != null)
                {
                    list.InsertArrayElementAtIndex(0);
        ...
        {
            SaveablePrefabsBuilding prefs = SaveablePrefabsBuilding.instance;
            List<string> ids = new List<string>();
            if (prefs == null)
            ...
            {
                SaveableEntityBuilding ent = (SaveableEntityBuilding)prefabs.GetArrayElementAtIndex(i).objectReferenceValue;
                if (ent != null)
            ...
            for (int i = 0; i < ids.Count; ++i)
            {
                for (int j = i + 1; j < ids.Count; ++j)
                {
                    if (ids[i] == ids[j])
                    {
                        SaveableEntityBuilding ent1 = (SaveableEntityBuilding)prefabs.GetArrayElementAtIndex(i).objectReferenceValue;
                        SaveableEntityBuilding ent2 = (SaveableEntityBuilding)prefabs.GetArrayElementAtIndex(j).objectReferenceValue;
                        ConflictData data;
                        data.obj1 = ent1;
