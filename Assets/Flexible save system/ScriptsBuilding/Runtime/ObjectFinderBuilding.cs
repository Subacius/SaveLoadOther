...
{
    public static class ObjectFinderBuilding
    {
    ...
    {
        public static T GetScriptableObject<T>(string ID) where T : Object, ISaveIDBuilding
        {
        ...
        public static T GetGameObject<T>(string ID) where T : Object, ISaveIDBuilding
        {
        ...
        {
            return SaveablePrefabsBuilding.GetPrefab(ID);
        }
    }
}